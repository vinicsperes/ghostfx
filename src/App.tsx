...
// Raised when the feedback guard cuts the audio. Centered + dimmed backdrop so a
// first-time mobile user (no headphones, no idea what the site is) understands
// what happened and how to fix it, instead of a tiny line of red text.
function FeedbackModal({ onResume }: { onResume: () => void }) {
  const accent = "#ff5a5a";
  return (
