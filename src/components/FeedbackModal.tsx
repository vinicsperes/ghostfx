      ...
      >
        ...
        <div className="flex items-start gap-3" style={{ padding: "20px 22px 12px" }}>
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              ...
              />
              <path
                d="M16 8.5a4 4 0 0 1 0 7M19.5 6a8 8 0 0 1 0 12"
                stroke={accent}
                strokeWidth="1.7"
                strokeLinecap="round"
              />
          ...
          <div style={{ paddingTop: 1 }}>
            ...
            <p
              ...
              style={{ fontSize: 19, color: "#fff", lineHeight: 1.05 }}
            >
              {FEEDBACK_T.title}
            </p>
          </div>
        ...
        <div style={{ padding: "0 22px 4px" }}>
          <p
            ...
            style={{ fontSize: 10.5, color: "rgba(188,178,182,0.62)", lineHeight: 1.55 }}
          >
            {FEEDBACK_T.body}
          </p>
          <div
          ...
          >
            ...
            >
              {FEEDBACK_T.hintTitle}
            </p>
            <p
              className="font-[var(--font-mono)]"
              style={{ fontSize: 9.5, color: "rgba(188,178,182,0.5)", lineHeight: 1.55 }}
            >
              {FEEDBACK_T.hint}
            </p>
          </div>
