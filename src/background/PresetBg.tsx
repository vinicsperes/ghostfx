...
import { PRESET_OPACITY, BLEND_OUT, BLEND_IN, INTRO_IDX, buildShader, type GlState } from "./shaders";

export default function PresetBg({ presetIdx, introActive = false }: { presetIdx: number | null; introActive?: boolean }) {
