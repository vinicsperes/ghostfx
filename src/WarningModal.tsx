    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 0 0 1px rgba(245,62,62,0.08), 0 40px 100px rgba(0,0,0,0.92), 0 0 80px rgba(245,62,62,0.05)",
        }}
      >
        <div
          style={{
            ...
            right: 0,
            height: 3,
            background: `linear-gradient(90deg, transparent 5%, ${RED}cc 40%, ${RED}cc 60%, transparent 95%)`,
          }}
        />
        ...
        >
          ...
          >
            <svg width="11" height="11" viewBox="0 0 24 24" fill="none">
              ...
              <path
                d="M10.5 3.5L2 19a1.7 1.7 0 0 0 1.5 2.5h17A1.7 1.7 0 0 0 22 19L13.5 3.5a1.73 1.73 0 0 0-3 0z"
                stroke={RED}
                strokeWidth="2"
        ...
        <p
          ...
          style={{ fontSize: 8, color: RED, letterSpacing: "0.35em", marginBottom: 9 }}
        >
          {T.badge}
        </p>
        <p
          className="font-[var(--font-display)]"
          style={{ fontSize: 22, color: "#fff", lineHeight: 1.05, letterSpacing: "0.01em" }}
        >
          {T.title}
        </p>
        ...
        >
          ...
          <span
            ...
            style={{
              fontSize: 10,
              color: confirmed ? "rgba(224,224,236,0.8)" : "rgba(168,168,188,0.45)",
